        ...
        <div className="banner">
          <div className="firstBox">
            ...
            <div className="content">
              ...
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis non maiores blanditiis eligendi esse nihil amet aut rerum? Deleniti, ipsam.</p>
            </div>
          </div>
          <div className="secondBox">
            <p>Total Appointments</p>
            
            <h3><span>{appointments.length}</span></h3>
          </div>
